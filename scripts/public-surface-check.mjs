...
const runtimeArtifactChecks = [
  { pattern: /(^|\/)\.iosctl\//, reason: "tracked iosctl run artifact" },
  ...
  { pattern: /\.xcresult(?:\/|$)/, reason: "tracked Xcode result bundle" },
];

const packArtifactChecks = [
  ...runtimeArtifactChecks,
  { pattern: /^(test|tests)\//, reason: "tests included in npm package" },
  { pattern: /^scripts\//, reason: "scripts included in npm package" },
  { pattern: /^src\//, reason: "source included in npm package" },
];
...
const secretPattern =
  /(AQ\.[A-Za-z0-9._-]{20,}|eyJ[A-Za-z0-9_-]{10,}\.[A-Za-z0-9_-]{10,}\.[A-Za-z0-9_-]{10,}|AKIA[0-9A-Z]{16}|AIza[0-9A-Za-z\-_]{20,}|gh[pousr]_[A-Za-z0-9]{20,}|github_pat_[A-Za-z0-9_]{20,}|sk_(?:live|test|proj)_[A-Za-z0-9]{16,}|sk-[A-Za-z0-9_-]{32,}|xai-[A-Za-z0-9_-]{32,}|xox[baporsc]-[A-Za-z0-9-]{10,}|ya29\.[A-Za-z0-9\-_]+|-----BEGIN [A-Z ]*PRIVATE KEY-----)/;
...
function scanTrackedFiles() {
  for (const relativePath of listTrackedFiles()) {
    checkPath("tracked", relativePath, runtimeArtifactChecks);
